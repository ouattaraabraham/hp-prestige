  ...
  return (
    <div className='relative overflow-hidden object-cover w-full lg:max-h-[500px]'>
        ...
        <div className='bg-black/60 flex items-center justify-center'>
          <p className='absolute text-slate-950 top-0  mx-auto px-[.75rem] w-full h-full flex items-center justify-center font-bold text-slate-100/80 text-xl text-center md:text-6xl max-w-[1000px]'>
          {props.header.p}
          </p>
        </div>
    </div>
